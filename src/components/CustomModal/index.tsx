...
export default function CustomModal() {
    ...
    const onClose = () => {
        dispatch(updateModal({ payload: { status: false, element: <div />, customSize: '' } }))
    }

    return (
        <Dialog maxWidth="md" aria-labelledby="customized-dialog-title" onClose={onClose} open={status}>
